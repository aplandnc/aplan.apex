...
export default function StaffHomePage() {
  return (
    <div>
      ...
      <p className={`mt-2 ${staffUi.text.body}`}>
        여기는 /staff 페이지입니다. (app) 레이아웃이 적용된 상태예요.
      </p>

      <div className={`mt-6 ${staffUi.card} border border-gray-200 bg-gray-50`}>
        <div className="text-sm font-semibold">다음 할 일</div>
        <ul className={`mt-2 list-disc pl-5 ${staffUi.text.body} space-y-1`}>
